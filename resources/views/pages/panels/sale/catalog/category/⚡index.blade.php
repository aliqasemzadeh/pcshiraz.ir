...
<div>
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between gap-3">
            <h1 class="text-2xl font-semibold text-heading">{{ __('general.categories') }}</h1>

            <button
                type="button"
                x-modal:open="{ modal: 'sale.catalog.category.create' }"
        ...
        <x-fwb.card>
            <livewire:sale.catalog.category-table :key="'sale-catalog-category-table'" />
        </x-fwb.card>
    </div>
</div>
