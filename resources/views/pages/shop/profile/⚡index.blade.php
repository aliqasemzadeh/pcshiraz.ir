...
<x-shop.profile-shell :title="__('general.profile_settings')">
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        @guest
            <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('general.login_or_register') }}</p>
        ...
        @auth
            @if ($this->identityVerified)
                <div class="flex items-start gap-3 rounded-lg border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-800 dark:border-emerald-800 dark:bg-emerald-950/40 dark:text-emerald-200">
    ...
    <div class="mt-6 flex flex-col items-center gap-2 border-t border-gray-200 pt-6 dark:border-gray-700">
