...
<div class="flex min-h-screen flex-col items-center justify-center px-4 py-8">
    <div class="w-full max-w-md space-y-6">
        <div class="text-center">
            <a href="{{ route('home') }}" wire:navigate class="text-2xl font-semibold text-navbar-fg dark:text-white">
                {{ config('app.name') }}
            </a>
        </div>

        <div class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-8">
            {{ $slot }}
        </div>
