...
<div>
    <x-input money wire:model="form.max_financiable_amount" :label="__('general.max_financiable_amount').' ('.price_unit_label().')'" />
...
<div>
    <x-input money wire:model="form.down_payment_required_above" :label="__('general.down_payment_required_above').' ('.price_unit_label().')'" />
...
<div class="grid grid-cols-2 gap-3">
    <div>
        <x-input money wire:model="form.min_order_amount" :label="__('general.min_order_amount').' ('.price_unit_label().')'" />
        @error('form.min_order_amount')
            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
        @enderror
    </div>
    <div>
        <x-input money wire:model="form.max_order_amount" :label="__('general.max_order_amount').' ('.price_unit_label().')'" />
